...
func UpdateReceipt(endpointsConf *config.EndpointsConfig) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		relateIngredient, err := helpers.ValidateIngredient(r.Header.Get("Authorization"), endpointsConf.Endpoints["warehouse-service"], newReceipt.IngredientId)
		if err != nil {
